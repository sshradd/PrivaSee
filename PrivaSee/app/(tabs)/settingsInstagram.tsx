...
const EditConfigs = () => {
  ...
  const openInfoModal = (level: string) => {
    ...
    if (level === "low") {
      ...
      content = <Text>This setting offers minimal privacy protection for ease of use.</Text>;
    } else if (level === "medium") {
      title = "Medium Privacy Setting";
      content = <Text>This setting balances privacy and ease of use.</Text>;
    } else if (level === "high") {
      title = "High Privacy Setting";
      content = <Text>This setting maximizes privacy with potential usage limitations.</Text>;
    }
    ...
    <PaperProvider theme={theme}>
      <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
        <Card style={styles.card}>
          ...
          <Link href="/(tabs)/advancedsetInstagram" asChild>
